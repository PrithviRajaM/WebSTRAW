...
WebSTRAW helps you to save a complete web page into a single HTML
file. WebSTRAW is a Web Extension (and a CLI tool) compatible with Chrome, Firefox
...
- [WebSTRAW](#webstraw)
  ...
  - [Command Line Interface (WebSTRAW CLI)](#command-line-interface-webstraw-cli)
  - [Integration with user scripts](#integration-with-user-scripts)
  - [File format comparison](#file-format-comparison)
  - [Projects using/compatible with WebSTRAW](#projects-usingcompatible-with-webstraw)
...
WebSTRAW can be installed from the store of:
...
(https://github.com/PrithviRajaM/WebSTRAW/archive/main.zip) of the project
...
- Click on the WebSTRAW button in the extension toolbar to save the page.
- You can click again on the button to cancel the action when processing a page.

## Additional notes

- Open the context menu by right-clicking the WebSTRAW button in the extension
...
- Right-click on the WebSTRAW button and select "Manage extension" (Firefox) /
...
See https://github.com/PrithviRajaM/WebSTRAW/blob/main/faq.md
...
See https://github.com/PrithviRajaM/WebSTRAW/blob/main/known-issues.md

## Command Line Interface (WebSTRAW CLI)
...
You can execute a user script just before (and after) WebSTRAW saves a page.
For more info, see
https://github.com/PrithviRajaM/WebSTRAW/wiki/How-to-execute-a-user-script-before-a-page-is-saved.
...
## Projects using/compatible with WebSTRAW
...
See https://github.com/PrithviRajaM/WebSTRAW/blob/main/privacy.md

## Contributors

See https://github.com/PrithviRajaM/WebSTRAW/blob/main/contributors.md
...
WebSTRAW is licensed under AGPL. Code derived from third-party projects is
licensed under MIT. Please contact me at gildas.lormeau &lt;at&gt; gmail.com if
you are interested in licensing the WebSTRAW code for a commercial service or
product.
