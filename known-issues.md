...
- All browsers:
  - For security reasons, you cannot save pages hosted on
    ...
    domains. When this happens, 🛇 is displayed on top of the WebSTRAW icon.
  - For
    [security reasons](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_enabled_image),
    WebSTRAW is sometimes unable to save the image representation of
  ...
  - The following characters are replaced by their full-width equivalent 
    ...
    options(https://github.com/PrithviRajaM/WebSTRAW/wiki/Hidden-options).
...
- Firefox:
  ...
  - Sometimes, WebSTRAW is unable to save the contents of sandboxed iframes
...
- If saving page in incognito did not fix the issue, reset WebSTRAW options.
...
- Please report the issue with a short description on how to reproduce it here:
  https://github.com/PrithviRajaM/WebSTRAW/issues.
